...
INTRO_TEXT = '''
OmniParser (Local Version) lets you turn any vision-language model into an AI agent that controls your local machine. 
We currently support **OpenAI (4o/o1/o3-mini), DeepSeek (R1), Qwen (2.5VL) or Anthropic Computer Use (Sonnet).**
...
with gr.Blocks(theme=gr.themes.Default()) as demo:
    ...
    if header_image:
        ...
        gr.HTML('<h1 style="text-align: center; font-weight: normal;">Omni<span style="font-weight: bold;">Tool</span> Local</h1>')
    else:
        gr.Markdown("# OmniTool Local")
